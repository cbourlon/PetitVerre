        ...
        <div className="Sektioner sm:pt-24 sm:px-10 sm:space-y-28 xl:pt-44 lg:space-y-36">
          <div className="PetitVerre ">
            ...
            <p className="description font-AvenirBook text-left md:text-center md:text-lg xl:text-xl sm:leading-7 md:leading-8 xl:leading-9 xl:pt-2 lg:max-w-[800px] ">
              ...
              magna duis. Maecenas diam egestas dolor cursus id. Turpis pulvinar
              lacus tincidunt in. Enim tristique lorem egestas accumsan diam
              vulputate hendrerit egestas risus. Lorem ipsum dolor sit amet
              consectetur. Tellus etiam praesent magna duis. Lorem ipsum dolor
              sit amet consectetur. Tellus etiam praesent magna duis.
            </p>
          </div>
          ...
          <div className="Lermitage md:flex md:flex-col md:items-center">
            ...
            <p className="description font-AvenirBook text-left md:text-center md:text-lg xl:text-xl sm:leading-7 md:leading-8 xl:leading-9 xl:pt-2 lg:max-w-[800px] ">
              ...
              beers. From collaborations to herb-infused brews, their creations
              capture the essence of craftsmanship. Discover Ermitage beers in
              Brussels' independent bars, restaurants, and specialty shops.
              Experience their unique vision at L'Ermitage Saint-Gilles bar and
              Les Caves de L'Ermitage wine shop. Cheers to a journey of flavor
              and friendship!
            </p>
          </div>
        </div>
