      ...
      <div className=" content flex sm:flex-col md:flex-row md:space-x-10 sm:py-5 sm:px-10 xl:px-72 xl:space-x-0  ">
        <div className="text md:bg-nigredo md:bg-opacity-50 md:rounded-xl md:p-10 md:pr-52 xl:py-20 xl:pl-20 xl:pr-96 relative">
          ...
          <p className="Tekst sm:text-left font-AvenirBook md:max-w-xs md:pt-2 lg:text-lg lg:pt-3 lg:max-w-sm xl:text-xl xl:leading-8 xl:max-w-lg ">
            Lorem ipsum dolor sit amet consectetur. Tellus etiam praesent magna
            duis. Maecenas diam egestas dolor cursus id. Turpis pulvinar lacus
            tincidunt in. Enim tristique lorem egestas accumsan diam vulputate
            hendrerit egestas risus. Lorem ipsum dolor sit amet consectetur.
            Tellus etiam praesent magna duis. Lorem ipsum dolor sit amet
            consectetur. Tellus etiam praesent magna duis.
          </p>
        </div>
        <div className="">
          <img
