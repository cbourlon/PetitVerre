        ...
        <div className="VenstreContent flex-1 lg:pt-12 ">
          <div className="tekst">
            <div className="overskrift font-Ermitial xl:text-8xl lg:text-5xl text-center">
              <h1 style={{ whiteSpace: "nowrap" }}>PRIVATE TASTING</h1>
            </div>
            ...
            <div className="description font-AvenirMedium text-center xl:text-2xl lg:pt-2 text-lg lg:pb-10 xl:pb-20 lg:mx-auto lg:max-w-xl xl:mx-auto xl:max-w-2xl">
              Indulge in an exquisite beer tasting experience that tantalizes
              your taste buds. Savor the rich flavors, distinct aromas, and
              expertly crafted brews. Discover a world mystery, smooth ales, and
              adventure. Unleash your inner beer connoisseur and embark on a
