      ...
      {data.Beers.map((item, i) => (
        ...
        >
          ...
          <div className="flex flex-col justify-center lg:w-2/3">
            <h1
              className={`Overskrift text-${item.beerColor} font-Ermitial lg:text-left md:text-5xl text-4xl text-center xl:text-8xl px-1`}
            >
              {item.name}
            </h1>

            <h2
              className={`Underoverskrift text-${item.beerColor} font-Ermitial xl:text-5xl lg:text-left md:text-2xl text-xl text-center`}
            >
              {item.beerTaste}
            </h2>
